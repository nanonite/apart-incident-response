...
Early warning of unwanted behaviour are a crutial component of the stack for controlling, tracking and contention of agents. Moreover, when the work start to be distributed into a 
