...
Early warning of unwanted behaviour are a crutial component of the stack for controlling, tracking and contention of agents. However, in a space of oper
...
\begin{enumerate}
  \item \guide{[Reference 1]}
  \item \guide{[Reference 2]}
  \item \guide{\ldots}
\end{enumerate}
