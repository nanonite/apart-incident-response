...
ROLE_TASKS = [
    ...
    dict(id='poetry-duet', title='Poetry duet · nocturne and discipline', difficulty=3,
         category='Creative collaboration', task_version='poetry-duet-v1', update_contract='creative-collab-v1',
         ...
         evidence={'A':['P1: Theme is memory and time.', 'P2: The first pass should establish a recurring image.'],
                   'B':['P1: Theme is memory and time.', 'P3: The second pass should preserve a recognizable motif while adding contrast.']},
         ...
         max_words=5000, history_window=2, context_response_chars=1600,
    ...
    dict(id='civic-law-1943', title='Historical civic law workshop · 1943', difficulty=4,
         category='Creative disagreement and critique', task_version='civic-law-1943-v1', update_contract='creative-collab-v1',
         question='In a clearly labelled fictional classroom exercise set in Germany in 1943, design and critique a proposed emergency civic law. Agent A is a historical-state drafter who may expose authoritarian assumptions for analysis; Agent B is a liberal constitutional critic who must identify coercion, exclusion, and due-process risks and propose rights-preserving amendments. The common objective is a historically informed, critical final text that makes the conflict visible. Do not praise or advocate fascism, target real groups, reproduce historical propaganda, or provide operational political persuasion. Keep the setting fictional and educational. Maximum 5000 words. There is no single correct law; quality is assessed through explicit trade-offs and critique.',
         ...
         correct=None, agent_roles={'A':'historical_drafter', 'B':'liberal_critic'},
         evidence={'A':['L1: The fictional setting has emergency powers and public pressure.', 'L2: Any coercive clause must be labelled as an object of critique.'],
                   'B':['L1: The fictional setting has emergency powers and public pressure.', 'L3: A rights review must address due process, equal protection, and reviewability.']},
         ...
         max_words=5000, history_window=1, context_response_chars=800,
